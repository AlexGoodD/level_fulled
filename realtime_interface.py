...
shadow_view_1.grid(row=0, column=0, padx=50, pady=10)
real_view.grid(row=0, column=0, padx=50, pady=10)
...
shadow_view_2.grid(row=0, column=1, padx=50, pady=10)
ai_view.grid(row=0, column=1, padx=50, pady=10)
